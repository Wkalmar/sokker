...
class NeuralScatterSkillsChart extends React.Component {


	activeTab = observable.box('stamina');
	...
	colors = {
		stamina: '#2876b4',
		pace: 'rgb(247, 126, 17)',
		technique: 'rgb(44, 160, 44)',
		passing: 'rgb(215, 39, 41)',
		keeper: '#2876b4',
		defender: 'rgb(247, 126, 17)',
		playmaker: 'rgb(44, 160, 44)',
		striker: 'rgb(215, 39, 41)'
	};
	...
	get chartData() {
		return this.players.map((player)=> {
			return {
				...
				pace: Math.round(player.pace * 100),
				technique: Math.round(player.technique * 100),
				passing: Math.round(player.passing * 100),
				keeper: Math.round(player.keeper * 100),
				defender: Math.round(player.defender * 100),
				playmaker: Math.round(player.playmaker * 100),
				striker: Math.round(player.striker * 100),
...
export default observer(NeuralScatterSkillsChart);